I used host to send commands using 2 serial converter one for the host and one for the BootLoader se when the BootLoader receive command it act upon it 
## Host
